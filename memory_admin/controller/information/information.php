...
if(isset($_POST['submit'])){
    ...
    if($erreur != 1){
        ...
        $req1 = $bdd->prepare('INSERT INTO informations_generales(contenu_informations_generales) VALUES( :contenu)');
        $req1->execute(array(
    ...
    if($erreur != 1){
        ...
        $req1 = $bdd->prepare('INSERT INTO actualites(contenu_actualites) VALUES( :contenu)');
        $req1->execute(array(
