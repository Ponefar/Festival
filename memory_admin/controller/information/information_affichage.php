...
$req1 = $bdd->prepare('SELECT * FROM informations_generales ORDER BY id_informations_generales DESC');
$req1->execute();
$compteur_req1 = $req1->rowCount();

$req2 = $bdd->prepare('SELECT * FROM actualites ORDER BY id_actualite DESC');
$req2->execute();
